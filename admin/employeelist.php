            ...
            <h4 class="c-grey-900 mT-10 mB-30">Employee List</h4>
         	<?php 
                if (isset($_GET['deluid'])) {
                	$deluid=$_GET['deluid'];
                	$delemp=$em->deleteSingleEmployee($deluid);
                    
                  }
               ?>
               <?php if(isset($delemp)&&$delemp!='success') {?>
            <div class="alert alert-danger alert-dismissible" data-auto-dismiss="2000" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong style="color: green;">Warning!</strong> <?php echo($delemp);?>
            </div>
          <?php }?>
           <?php if(isset($delemp)&&$delemp=='success') {?>
            <div class="alert alert-success alert-dismissible" data-auto-dismiss="2000" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong style="color: green;">Success!</strong> <?php echo('<span>data deleted successful</span>');?>
            </div>
          <?php }?>
          <div class="row">
                <div class="col-md-12">
