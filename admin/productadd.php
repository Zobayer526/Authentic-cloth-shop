            ...
            <div class="masonry-item col-md-12">
                <div class="bgc-white p-20 bd">
                    <h1 class="c-grey-900">New Product</h1>
                      <?php if(isset($insertProduct) && $insertProduct=='success') {?>
                        <div class="alert alert-success alert-dismissible" data-auto-dismiss="2000" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <strong style="color: green;">Success!</strong> <?php echo(' Data inserted successfully');?>
                        </div>
                      <?php }?>
                      <?php if(isset($insertProduct)&& $insertProduct!='success') {?>
                        <div class="alert alert-danger alert-dismissible" data-auto-dismiss="2000" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <strong style="color: red;">Warning!</strong> <?php echo($insertProduct);?>
                        </div>
                      <?php }?>
                    ...
                    <div class="mT-30">
                        <form  method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="productName" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter product name" required="required"> 
                            </div>
                           <div class="form-group">
                                <label for="exampleInputEmail1">Category&nbsp <span style="color: red;">*</span> </label>
                                <select class="form-control" id="sel2" name="catId" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sel2" name="city" required="required">
                           ...
                           <div class="form-group" style="display: none;">
                            ...
                            <div class="form-group"  style="display: none;">
                                ...
                                <option value="null" selected>None</option>
                                <option value="small(1/2 KG)">Small (1/2 PC)</option>
                                <option value="midium(1 KG)">Midium (1 PC)</option>
                                <option value="large(2 KG)">Large (2 PC)</option>
                              </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Content</label>
                                <textarea class="form-control" rows="5" id="comment" name="body" required="required"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="price" required="required"> 
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Quantity&nbsp <span style="color: red;">*</span></label>
                                <input type="number" min="1" name="qty" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="1" max="1000" required="required" > 
                            </div>
                            <div class="form-group">
