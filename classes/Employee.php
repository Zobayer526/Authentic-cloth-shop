...
class Employee {
	...
	public function addEmployee($data){
	       ...
	       $password=$this->fm->validation(md5($data['password']));
	        ...
	        if (empty($userName)|| empty($password)||empty($password)||empty($email)||empty($name)) {
	         ...
	         if ($checkmail !=false) {
	            ...
	            $query="insert into users(name,email,password,typeofuser,role) values('$name','$email','$password','$userName','$role')";
 ...
 if ($file_size >1048567) {
	...
	return $allusers;
     ...
     public function deleteEmployee($deluid,$bid){
        ...
        if ($deluserdata) {
           ...
           return $msg;
        		...
        		$msg="<span class='success'> user unblock successfully!</span>";
           return $msg;
        	}
     ...
     public function deleteSingleEmployee($deluid){
