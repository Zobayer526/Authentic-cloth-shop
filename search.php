 ...
 <!-- bannar-->
    <div  class="ps-hero bg--cover" data-background="admin/upload/back.jpg">
        <div class="ps-hero__content">
            <h1 style="color: #f7f7f7;"> Rokomary Food</h1>
            <div class="ps-breadcrumb">
                <ol class="breadcrumb">
                    <li><a href="index.php" style="color: #f7f7f7; font-size: 20px;">Home</a></li>
                    <li class="active" style="color: #f7f7f7; font-size: 20px;">Search</li>
                </ol>
            </div>
        </div>
    </div>
               ...
               ?>
                ...
                <div class="ps-column">
                    <div class="ps-product">
                        <div class="ps-product__thumbnail"><img width="210" height="160" src="admin/<?php echo($result['img']); ?>" alt=""><a class="ps-product__overlay" href="details.php?pdId=<?php echo($result['id']); ?>"></a>
