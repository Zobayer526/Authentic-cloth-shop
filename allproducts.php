...
<!-- bannar-->
    <div class="ps-hero bg--cover" data-background="admin/upload/back.jpg">
        <div class="ps-hero__content" style="color: #723105;">
            <h1 style="color: #afaba8;"> Authentic Cloths Shop</h1>
            <div class="ps-breadcrumb">
                <ol class="breadcrumb" >
                    <li><a href="index.php" style="color: #f7f7f7; font-size: 20px;">Home</a></li>
                    <li class="active" style="color: #f7f7f7; font-size: 20px;">All product</li>
                </ol>
            </div>
        </div>
    </div>
